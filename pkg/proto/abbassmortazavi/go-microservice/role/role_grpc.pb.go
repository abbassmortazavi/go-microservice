...
const (
	...
	RoleService_Lists_FullMethodName  = "/role.RoleService/Lists"
)
...
func (c *roleServiceClient) Lists(ctx context.Context, in *ListRolesRequest, opts ...grpc.CallOption) (*ListRoleResponse, error) {
	...
	err := c.cc.Invoke(ctx, RoleService_Lists_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRoleServiceServer) Lists(context.Context, *ListRolesRequest) (*ListRoleResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Lists not implemented")
}
...
func _RoleService_Lists_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RoleService_Lists_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
