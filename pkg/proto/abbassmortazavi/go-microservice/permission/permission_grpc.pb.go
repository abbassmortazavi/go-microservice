...
const (
	...
	PermissionService_Lists_FullMethodName  = "/permission.PermissionService/Lists"
)
...
func (c *permissionServiceClient) Lists(ctx context.Context, in *ListPermissionsRequest, opts ...grpc.CallOption) (*ListPermissionResponse, error) {
	...
	err := c.cc.Invoke(ctx, PermissionService_Lists_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PermissionService_Lists_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PermissionService_Lists_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
