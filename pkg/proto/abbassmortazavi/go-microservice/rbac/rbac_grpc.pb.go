...
const (
	RBACService_AssignPermissionToRole_FullMethodName = "/rbac.RBACService/AssignPermissionToRole"
	RBACService_AssignRoleToUser_FullMethodName       = "/rbac.RBACService/AssignRoleToUser"
	RBACService_CheckUserRole_FullMethodName          = "/rbac.RBACService/CheckUserRole"
)
...
func (c *rBACServiceClient) CheckUserRole(ctx context.Context, in *CheckUserRoleRequest, opts ...grpc.CallOption) (*CheckUserRoleResponse, error) {
	...
	err := c.cc.Invoke(ctx, RBACService_CheckUserRole_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRBACServiceServer) CheckUserRole(context.Context, *CheckUserRoleRequest) (*CheckUserRoleResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CheckUserRole not implemented")
}
...
func _RBACService_CheckUserRole_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RBACService_CheckUserRole_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
